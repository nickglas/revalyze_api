...
export class MailService {
  ...
  async sendAccountActivationEmail(to: string, activationToken: string) {
    const activationUrl = `http://localhost:4000/activate-account?token=${activationToken}`;
              ...
              <table class="inner-table" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;color:#ffffff;background-color:#000;">
                ...
                <tr>
                  <td align="center" style="padding:30px 20px 10px;">
                    <h1 style="margin:0;font-size:24px;font-weight:700;">Welcome to Revalyze!</h1>
                ...
                <tr>
                  <td align="center" style="padding:20px 30px;color:#cccccc;font-size:15px;">
                    You're receiving this email because your Revalyze account has been created.
                ...
                <tr>
                  <td align="center" style="font-size:12px;color:#888888;padding-bottom:20px;">
                    Link expires in 24 hours for security reasons.
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:20px 30px;color:#cccccc;font-size:14px;">
                    <strong style="color:#ffffff;">Didn't sign up?</strong>
                    <p style="margin:8px 0 0;">
                      You can safely ignore this message. No account will be created unless you confirm.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:0 30px 40px;color:#cccccc;font-size:14px;">
                    ...
                    <p style="margin:8px 0 0;">
                      Our support team is ready to help you if you have any issues activating your account.
                    </p>
                  </td>
                </tr>
                      ...
                      <tr>
                        <td class="footer-column" width="33%" valign="top" style="vertical-align:top;padding:0 10px;">
                          ...
                          <p style="margin:8px 0;">
                            <a href="#" style="color:#ffffff;text-decoration:none;">Features</a>
                          </p>
                          <p style="margin:8px 0;">
                            <a href="#" style="color:#ffffff;text-decoration:none;">Pricing</a>
                          </p>
                        </td>
                        <td class="footer-column" width="33%" valign="top" style="vertical-align:top;padding:0 10px;">
                          <strong>RESOURCES</strong>
                          <p style="margin:8px 0;">
                            <a href="#" style="color:#ffffff;text-decoration:none;">Help Center</a>
                          </p>
                          <p style="margin:8px 0;">
                            <a href="#" style="color:#ffffff;text-decoration:none;">API Docs</a>
                          </p>
                        </td>
                        <td class="footer-column" width="33%" valign="top" style="vertical-align:top;padding:0 10px;">
